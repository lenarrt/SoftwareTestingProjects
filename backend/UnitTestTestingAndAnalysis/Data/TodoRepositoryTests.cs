...
namespace FS.Todo.Tests.Data
{
    public class TodoRepositoryTests
    {
        ...
        [Fact]
        public async void Can_Find_Todo()
        {
            // Arrange
            var testTodo = new Todo.Data.Entities.Todo
            {
            ...
            {
                var repository = new TodoRepository(context);
                var todo = await repository.FindAsync(testTodo.Id);
        ...
        [Fact]
        public async void Can_Remove_Todo()
        {
            // Arrange
            var testTodo = new Todo.Data.Entities.Todo
            {
            ...
            {
                var repository = new TodoRepository(context);
                await repository.RemoveAsync(testTodo.Id);
            }
